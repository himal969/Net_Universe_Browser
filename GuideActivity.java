...
import com.Himal.Browser.model.GuideModel;
import com.Himal.Browser.R;
import com.Himal.Browser.adapter.GuideAdapter;
...
public class GuideActivity extends AppCompatActivity {
    ...
    private List<GuideModel> getList() {
        ...
        list.add(new GuideModel("3", "Click the downloader button", R.drawable.info_three));
